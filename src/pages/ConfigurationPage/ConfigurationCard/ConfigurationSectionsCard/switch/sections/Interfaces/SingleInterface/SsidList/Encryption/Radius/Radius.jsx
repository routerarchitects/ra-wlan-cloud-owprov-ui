...
import ToggleField from 'components/FormFields/ToggleField';
  ...
  onAccountingChange: (e) => void;
  isAccountingEnabled: boolean;
  onDynamicChange: (e) => void;
  ...
  <>
    ...
    {isEnabled &&
      (isUsingCustom || !variableBlock ? (
        <>
          ...
          <FormControl isDisabled={!editing}>
            ...
            <Switch
              ...
              size="lg"
              isDisabled={!editing}
              _disabled={{ opacity, cursor: 'not-allowed' }}
            />
          </FormControl>
          {isDynamicEnabled && (
        ...
        <div style={{ padding, background, borderRadius)}) - editing temporarily unavailable</small></div>
      ))}
  </>
);
