...
export const ETHERNET_BPDU_GUARD_SCHEMA = (t, useDefault = false) => {
...
export const ETHERNET_DHCP_SNOOP_PORT_SCHEMA = (t, useDefault = false) => {
  const shape = object().shape({
...
export const ETHERNET_STORM_CONTROL_SCHEMA = (t, useDefault = false) => {
  const shape = object().shape({
...
export const ETHERNET_POE_SCHEMA = (t, useDefault = false) => {
  const shape = object().shape({
...
export const ETHERNET_LLDP_SCHEMA = (t, useDefault = false) => {
  const shape = object().shape({
...
export const ETHERNET_VOICE_VLAN_SCHEMA = (t, useDefault = false) => {
  const shape = object().shape({
...
export const ETHERNET_ENTRY_SCHEMA = (t, useDefault = false) => {
  const shape = object().shape({
...
export const ETHERNET_SCHEMA = (t, useDefault = false) =>
  object().shape({
    configuration: array().of(ETHERNET_ENTRY_SCHEMA(t, useDefault)).default([]),
  });

export const getEthernetEntryDefaults = (t) => {
