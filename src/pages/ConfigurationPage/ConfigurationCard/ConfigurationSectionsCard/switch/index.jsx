...
const ConfigurationSectionsCard = ({ configId, editing, setSections, label, onDelete, defaultConfig }) => {
  ...
  const setConfigSectionsFromArray = (arr, shouldValidate) => {
    ...
    setTimeout(() => {
      ...
      if (newActiveConfigs.includes('ethernet')) {
        setEthernet({
          data: getConfigurationData(arr, 'ethernet'),
          isDirty: false,
          invalidValues: [],
          shouldValidate,
        });
  ...
  useEffect(() => {
    if (!editing && configuration) {
      ...
      if (newActiveConfigs.includes('ethernet')) {
        setEthernet({
          data: getConfigurationData(configuration.configuration, 'ethernet'),
          isDirty: false,
          invalidValues: [],
        });
      }
  ...
  }, [globals, unit, metrics, services, ethernet, interfaces, thirdParty, activeConfigurations, configuration]);
